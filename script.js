...
const translations = {
  en: {
    ...
    'hero.intro': 'Year 2 ROAS + AI undergraduate at HKUST(GZ), exploring embodied perception, robot manipulation, computer vision, and AI for healthcare.',
  ...
  zh: {
    ...
    'hero.intro': '香港科技大学（广州）ROAS + AI 大二学生，探索具身感知、机器人操作、计算机视觉与医疗 AI。',
