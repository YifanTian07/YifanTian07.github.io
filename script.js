...
const translations = {
  en: {
    ...
    'publications.jtoma.authors': 'Preprint · <strong>Yifan Tian</strong> and collaborators',
    'publications.jtoma.type': 'arXiv preprint',
    'publications.jtoma.status': 'Publication link being updated',
  ...
  zh: {
    ...
    'publications.jtoma.authors': '预印本 · <strong>Yifan Tian</strong> 与合作者',
    'publications.jtoma.type': 'arXiv 预印本',
    'publications.jtoma.status': '论文链接待更新',
    'projects.title': '代表项目。',
