...
const translations = {
  en: {
    ...
    'a11y.diagram': 'Ocean Glass monogram connecting perception and action',
    ...
    'hero.statement': 'I build perception into action.',
    'hero.intro': 'First-year ROAS + AI undergraduate at HKUST(GZ), exploring embodied perception, robot manipulation, computer vision, and responsible healthcare AI.',
    'hero.researchCta': 'View research',
    ...
    'projects.g1.tag': 'HUMANOID · TELEOP · π0.5',
    'projects.g1.body': 'An end-to-end humanoid learning system spanning dual teleoperation, LeRobot data, π0.5 training, simulation, and physical deployment.',
  ...
  zh: {
    ...
    'a11y.diagram': '连接感知与行动的 Ocean Glass 字母图形',
    ...
    'hero.statement': '让感知，真正成为行动。',
    'hero.intro': '香港科技大学（广州）ROAS + AI 大一学生，探索具身感知、机器人操作、计算机视觉与负责任的医疗 AI。',
    'hero.researchCta': '查看科研',
    ...
    'projects.g1.tag': '人形机器人 · 遥操作 · π0.5',
    'projects.g1.body': '一套覆盖双遥操作、LeRobot 数据、π0.5 训练、仿真验证与真机部署的端到端人形机器人学习系统。',
